...
In this analysis the main generator is \POWHEG{v2} which calculates the production process at NLO. The decay of the top quark is calculated at leading order, but
...
The NNPDF set is chosen to simulate the PDF for all simulated processes. \todo{cite}
...
to describe previously measured data. In this analysis the \PYTHIA algorithm with the \todo{cite+tune} tune is used.
