...
%********************************** %Second Section  *************************************
\section{Method using independent triggers} %Section - 1.2
...
\begin{figure}[htbp!]
  \begin{center}
    \resizebox{0.65 \textwidth}{!}{\includegraphics{Trigger/Figures/SingleEle_Comparison}}
    \resizebox{0.65 \textwidth}{!}{\includegraphics{Trigger/Figures/SingleMu_Comparison_RunG}}        
